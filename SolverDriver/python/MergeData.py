...
def main():
  ...
  new_data_df = load_dataset(new_data_csv)
  original_data_df  = load_dataset(original_data_csv)
  ...
  original_data_df.sort_index()
  original_data_df.to_csv('original_df.csv', index=False)
